                    ...
                    >
                        ...
                        >
                            ...
                            <li class="pl-10 pr-6 py-2 cursor-pointer hover:bg-black hover:bg-opacity-30 transition duration-200 hover:text-gray-100">
                                ...
                                >
                                    <span class="mr-2 text-sm">&bull;</span>
                                    <span class="overflow-ellipsis">Catergory 1</span>
                                </a>
                            </li>
                            <!-- end::Submenu link -->
                            ...
                            <li class="pl-10 pr-6 py-2 cursor-pointer hover:bg-black hover:bg-opacity-30 transition duration-200 hover:text-gray-100">
                                ...
                                >
                                    <span class="mr-2 text-sm">&bull;</span>
                                    <span class="overflow-ellipsis">Category 2</span>
                                </a>
                            </li>
                            <!-- end::Submenu link -->
                            ...
                            <li class="pl-10 pr-6 py-2 cursor-pointer hover:bg-black hover:bg-opacity-30 transition duration-200 hover:text-gray-100">
                                ...
                                >
                                    <span class="mr-2 text-sm">&bull;</span>
                                    <span class="overflow-ellipsis">Category 3</span>
                                </a>
                            </li>
                            <!-- end::Submenu link -->
                            ...
                            <li class="pl-10 pr-6 py-2 cursor-pointer hover:bg-black hover:bg-opacity-30 transition duration-200 hover:text-gray-100">
                                ...
                                >
                                    <span class="mr-2 text-sm">&bull;</span>
                                    <span class="overflow-ellipsis">Create New Category</span>
                                </a>
                            </li>
                            <!-- end::Submenu link -->
                        </ul>
