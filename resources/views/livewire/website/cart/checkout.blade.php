<div class="w-11/12 md:w-5/6 mx-auto md:flex justify-between gap-10">
    <div class="py-5 md:w-3/5 w-full"> 
        ...
        <form wire:submit.prevent="submit" class="space-y-10 py-5">
            <div class="md:flex justify-between md:gap-5 space-y-10 md:space-y-0">
                <input wire:model.debounce.500ms="first_name" type="text" placeholder="First Name *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
                <input wire:model.debounce.500ms="last_name" type="text" placeholder="Last Name *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
            </div>
            <div class="md:flex justify-between md:gap-5 space-y-10 md:space-y-0">
                <input wire:model.debounce.500ms="email" type="text" placeholder="Email *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
                <input wire:model.debounce.500ms="tel" type="tel" placeholder="Phone Number *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
            </div>
            <div class="md:flex justify-between md:gap-5 space-y-10 md:space-y-0">
                <input wire:model.debounce.500ms="lodge" type="text" placeholder="Lodge *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
                <select wire:model.lazy="area" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] text-gray-500 border-gray-300">
            ...
            <div>
                <textarea wire:model.debounce.500ms="additional_information" name="" id="" rows="10" placeholder="Additional Information" class="rounded-md p-3 block w-full focus:ring-0 focus:border-[#101820] border-gray-300"></textarea>
            </div>
        </form>
    </div>
