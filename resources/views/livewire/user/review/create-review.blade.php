<div>
    <div class="p-8 bg-gray-900">
        <div>
            <h1 class="text-2xl text-center text-gray-200 font-semibold">Create a new Review</h1>
            <form wire:submit.prevent="submit" class="mt-5 text-gray-200 space-y-10">
                ...
                <div>
                    <input type="text" wire:model.debounce.500ms="twitter" class="block w-full bg-gray-800 focus:ring-0 focus:border-gray-200 rounded-md" placeholder="Twitter" autofocus>
                    @error('twitter') <span class="text-red-600 font-bold">{{ $message }}</span> @enderror
                </div>
                <div>
                    <input type="text" wire:model.debounce.500ms="instagram" class="block w-full bg-gray-800 focus:ring-0 focus:border-gray-200 rounded-md" placeholder="Instagram" autofocus>
                    @error('instagram') <span class="text-red-600 font-bold">{{ $message }}</span> @enderror
                </div>
                <div>
                    <input type="text" wire:model.debounce.500ms="tiktok" class="block w-full bg-gray-800 focus:ring-0 focus:border-gray-200 rounded-md" placeholder="Tiktok" autofocus>
