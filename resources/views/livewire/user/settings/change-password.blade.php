<div class="bg-gray-800 w-full mx-auto p-4 md:p-8 rounded-md text-gray-200 mt-20">
    <h1 class="font-semibold text-lg md:text-2xl border-b pb-4">Change Password? - Sure, just below here.</h1>
            ...
            <div class="flex flex-col">
                ...
                >
                    <input 
                        ...
                        class="w-full rounded-md text-gray-200 bg-gray-900 focus:ring-0 focus:border-purple-600 mt-2 p-2"
                    >
