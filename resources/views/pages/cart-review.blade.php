<x-page-layout>
    ...
    <section>
        <div class="w-11/12 md:w-5/6 mx-auto py-10">
            <div class="border p-4 rounded-md bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-20 shadow-xl overflow-hidden">
