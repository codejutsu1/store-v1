            ...
            <div class="py-5 md:w-3/5 w-full"> 
                ...
                <form action="#" class="space-y-10 py-5">
                    <div class="md:flex justify-between md:gap-5 space-y-10 md:space-y-0">
                        <input type="text" placeholder="First Name *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
                        <input type="text" placeholder="Last Name *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
                    </div>
                    <div class="md:flex justify-between md:gap-5 space-y-10 md:space-y-0">
                        <input type="text" placeholder="Email *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
                        <input type="tel" placeholder="Phone Number *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
                    </div>
                    <div class="md:flex justify-between md:gap-5 space-y-10 md:space-y-0">
                        <input type="text" placeholder="Lodge *" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] border-gray-300">
                        <select name="area" id="area" class="rounded-md p-3 block w-full md:w-1/2 focus:ring-0 focus:border-[#101820] text-gray-500 border-gray-300">
